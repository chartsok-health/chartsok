...
const content = {
  ko: {
    ...
    faqs: [
      {
        q: '녹음 파일은 어떻게 처리되나요?',
        a: '녹음된 음성 파일은 텍스트 변환 즉시 삭제되고, 대화 기록(텍스트)은 24시간 후 자동 삭제됩니다. 차트와 안내문은 안전하게 보관됩니다. 이것이 chartsok의 핵심 정책입니다.',
      },
      {
        q: '대화 기록은 언제 삭제되나요?',
        a: '대화 기록(텍스트)은 생성 후 24시간이 지나면 자동으로 삭제됩니다. 생성된 차트, 환자 안내문, 후속 조치 항목은 삭제되지 않고 안전하게 보관됩니다.',
      },
      {
        q: 'EMR에 어떻게 입력하나요?',
