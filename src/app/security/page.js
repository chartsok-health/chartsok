      ...
      items: [
        {
          ...
          highlight: '음성 즉시 삭제 · 대화 기록 24시간 후 삭제',
          description: '녹음된 음성 파일은 텍스트 변환 즉시 삭제되고, 대화 기록(텍스트)은 24시간 후 자동 삭제됩니다. 차트와 안내문은 안전하게 보관됩니다.',
          details: [
            '음성 파일은 변환 완료와 동시에 서버에서 영구 삭제',
            '대화 기록(텍스트)은 24시간 후 자동 삭제',
            '차트, 안내문, 후속 조치는 안전하게 보관',
            '삭제 처리 로그 확인 가능',
          ],
          color: '#EF4444',
        },
        {
          icon: TimerIcon,
          title: '대화 기록 24시간 후 자동 삭제',
          highlight: '24시간 후 자동 삭제',
  ...
  en: {
    ...
    keyPolicies: {
      ...
      items: [
        ...
        {
          icon: TimerIcon,
          title: 'Conversation Text Auto-Deleted After 24 Hours',
          highlight: 'Auto-deleted after 24 hours',
          description: 'Transcribed conversation text is automatically deleted 24 hours after creation. Generated charts, patient instructions, and follow-up actions are securely retained.',
          details: [
            'Conversation text auto-deleted after 24 hours',
            'Charts, instructions, and actions are securely stored',
            'Review conversation text before deletion',
            'Deletion logs available for verification',
          ],
          color: '#F59E0B',
        },
