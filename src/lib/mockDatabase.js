...
export const patients = [
  { id: 1, chartNo: 'P-2024-001', hospitalId: 'hosp_c3d4e5f6-a7b8-4c9d-0e1f-2a3b4c5d6e7f', name: '김영희', birthDate: '1979-03-15', age: '45세', gender: '여', phone: '010-1234-5678', address: '서울시 강남구', bloodType: 'A+', createdAt: Date.now() - 365 * 24 * 60 * 60 * 1000 },
  { id: 2, chartNo: 'P-2024-002', hospitalId: 'hosp_c3d4e5f6-a7b8-4c9d-0e1f-2a3b4c5d6e7f', name: '박철수', birthDate: '1962-07-22', age: '62세', gender: '남', phone: '010-2345-6789', address: '서울시 서초구', bloodType: 'B+', createdAt: Date.now() - 300 * 24 * 60 * 60 * 1000 },
  { id: 3, chartNo: 'P-2024-003', hospitalId: 'hosp_c3d4e5f6-a7b8-4c9d-0e1f-2a3b4c5d6e7f', name: '이민정', birthDate: '1991-11-08', age: '33세', gender: '여', phone: '010-3456-7890', address: '서울시 송파구', bloodType: 'O+', createdAt: Date.now() - 200 * 24 * 60 * 60 * 1000 },
  { id: 4, chartNo: 'P-2024-004', hospitalId: 'hosp_c3d4e5f6-a7b8-4c9d-0e1f-2a3b4c5d6e7f', name: '정대현', birthDate: '1966-01-30', age: '58세', gender: '남', phone: '010-4567-8901', address: '서울시 강동구', bloodType: 'AB+', createdAt: Date.now() - 180 * 24 * 60 * 60 * 1000 },
  { id: 5, chartNo: 'P-2024-005', hospitalId: 'hosp_c3d4e5f6-a7b8-4c9d-0e1f-2a3b4c5d6e7f', name: '최수진', birthDate: '1988-09-12', age: '36세', gender: '여', phone: '010-5678-9012', address: '서울시 마포구', bloodType: 'A-', createdAt: Date.now() - 150 * 24 * 60 * 60 * 1000 },
  { id: 6, chartNo: 'P-2024-006', hospitalId: 'hosp_c3d4e5f6-a7b8-4c9d-0e1f-2a3b4c5d6e7f', name: '강민호', birthDate: '1973-05-25', age: '51세', gender: '남', phone: '010-6789-0123', address: '서울시 용산구', bloodType: 'B-', createdAt: Date.now() - 120 * 24 * 60 * 60 * 1000 },
  { id: 7, chartNo: 'P-2024-007', hospitalId: 'hosp_c3d4e5f6-a7b8-4c9d-0e1f-2a3b4c5d6e7f', name: '윤서연', birthDate: '1985-12-03', age: '39세', gender: '여', phone: '010-7890-1234', address: '서울시 종로구', bloodType: 'O-', createdAt: Date.now() - 90 * 24 * 60 * 60 * 1000 },
  { id: 8, chartNo: 'P-2024-008', hospitalId: 'hosp_c3d4e5f6-a7b8-4c9d-0e1f-2a3b4c5d6e7f', name: '임재혁', birthDate: '1954-08-17', age: '70세', gender: '남', phone: '010-8901-2345', address: '서울시 중구', bloodType: 'AB-', createdAt: Date.now() - 60 * 24 * 60 * 60 * 1000 },
  { id: 9, chartNo: 'P-2024-009', hospitalId: 'hosp_c3d4e5f6-a7b8-4c9d-0e1f-2a3b4c5d6e7f', name: '한소희', birthDate: '1995-04-20', age: '29세', gender: '여', phone: '010-9012-3456', address: '서울시 영등포구', bloodType: 'A+', createdAt: Date.now() - 45 * 24 * 60 * 60 * 1000 },
  { id: 10, chartNo: 'P-2024-010', hospitalId: 'hosp_c3d4e5f6-a7b8-4c9d-0e1f-2a3b4c5d6e7f', name: '조현우', birthDate: '1980-06-08', age: '44세', gender: '남', phone: '010-0123-4567', address: '서울시 성동구', bloodType: 'B+', createdAt: Date.now() - 30 * 24 * 60 * 60 * 1000 },
];
