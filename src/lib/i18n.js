    ...
    features: {
      ...
      items: [
        ...
        },
        {
          ...
          description: '녹음된 음성은 텍스트 변환 직후 서버에서 완전히 삭제됩니다. 대화 기록(텍스트)도 24시간 후 자동 삭제됩니다. 보안이 기본입니다.',
          icon: 'security',
          features: ['음성 파일 변환 후 즉시 삭제', '대화 기록 24시간 후 자동 삭제', '차트·안내문은 안전하게 보관', '삭제 로그 확인 가능'],
        },
      ],
    },
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          answer: '녹음된 음성 파일은 텍스트 변환 즉시 삭제되고, 대화 기록(텍스트)은 24시간 후 자동 삭제됩니다. 차트와 안내문은 안전하게 보관됩니다.',
        },
        {
